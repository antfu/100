...
paper(@mouseup='mouseup' @touchend='mouseup')
  .box.fixed.overflow-hidden.bg-white(
    ...
    .inner.absolute.p-10(:style='{top: px(innerY), left: px(innerX), height: px(screenHeight), width: px(screenWidth)}')
      ...
      h3.font-bold.mt-4.mb-2 Section 1.10.32 of "de Finibus Bonorum et Malorum", written by Cicero in 45 BC
      ...
      h3.font-bold.mt-4.mb-2 1914 translation by H. Rackham
      ...
      h3.font-bold.mt-4.mb-2 Section 1.10.33 of "de Finibus Bonorum et Malorum", written by Cicero in 45 BC
